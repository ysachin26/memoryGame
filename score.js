...
// NOTE: score.js only exports helper functions. Do not perform DOM access
// or reference game-global variables from this module — use the
// importing module (`script.js`) to call `fetchScore()` and update the UI.
